...
<!-- # ```{r ageclasses-pandemic-hosp-timeline, out.width="100%", fig.asp=0.55, dpi=150, out.extra='class="img-centered img-responsive"'} -->
<!-- #  -->
...
<!-- </div> -->
<!-- </div> -->
<!-- # ```{r ageclasses-pandemic-death-timeline, warning=FALSE, out.width="100%", fig.asp=0.55, dpi=150, out.extra='class="img-centered img-responsive"'} -->
<!-- #  -->
...
<!-- ```{r ageclasses-pandemic-hosp-timeline-fullyvac, out.width="100%".667, fig.asp=0.55, dpi=150, out.extra='class="img-centered img-responsive"'} -->
...
<!-- ``` -->
<!-- ```{r ageclasses-pandemic-deaths-timeline-fullyvac, fig.width=6.667, fig.asp=0.55, dpi=150, out.extra='class="img-centered img-responsive"'} -->
...
```{r ageclasses-pandemic-hosp-deaths-timeline_100k-graph, warning=FALSE, out.width="100%", fig.asp=0.8, dpi=150, out.extra='class="img-responsive"'}
...
```
```{r ageclasses-pandemic-hosp-deaths-timeline_ratio-graph, warning=FALSE, out.width="100%", fig.asp=0.8, dpi=150, out.extra='class="img-responsive"'}
