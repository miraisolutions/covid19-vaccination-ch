...
As of Today, (**`r Sys.Date()`**), the 4 last weeks considered are: **`r weeks4`** (year-W-Week Number), i.e. in the interval from **`r weeks_from_to[1]`** to **`r weeks_from_to[2]`**.
...
```{r ageclasses-pandemic-month, warning=FALSE, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-pandemic-month-100k, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-vacc-perc, warning=FALSE, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'}
Pop <- DATA.AG1M %>%
    filter((!AgeClass %in% c("unknown"))) %>%
    select(-Week) %>%  
    group_by(AgeClass) %>%
...
```{r ageclasses-vacc-unvac, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-vacc-unvac-scale100k-plot, warning=FALSE, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-vacc-unvac-scale100k-graph, warning=FALSE, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-cases-scenarios-100k, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-cases-scenarios, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'}
...
<!-- # ```{r ageclasses-pandemic-hosp-timeline, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'} -->
<!-- #  -->
...
<!-- </div> -->
<!-- </div> -->
<!-- # ```{r ageclasses-pandemic-death-timeline, warning=FALSE, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'} -->
<!-- #  -->
...
```{r ageclasses-pandemic-hosp-deaths-timeline_100k-graph, warning=FALSE, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-responsive"'}
...
renderPlotly({
      ...
      message("case: ", input$case1)
      message("status: ", input$status1)
      dat <- data1 %>% filter(Case == input$case1)
      if (input$status1 != "All")
        dat <- dat %>%  filter(Status == input$status1)
...
```{r ageclasses-pandemic-hosp-deaths-timeline_ratio, warning=FALSE, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```
```{r ageclasses-pandemic-hosp-deaths-timeline_ratio-graph, warning=FALSE, fig.width=6, fig.asp=0.6, dpi=150, out.extra='class="img-responsive"'}
...
renderPlotly({
      ...
      message("case: ", input$case2)
      message("status: ", input$status2)
      dat <- data2 %>% filter(Case == input$case2)
      if (input$status2 != "All")
        dat <- dat %>%  filter(Status == input$status2)
      col_status <- vac_levels_colors()[as.character(unique(dat$Status))] 
      dat_start <- dat %>% group_by(AsOfDate) %>% summarize(sumvalue = sum(Value, na.rm = TRUE)) %>%
        filter(sumvalue > 0) %>% summarize(mindate = min(AsOfDate)) %>% as.data.frame() %>% .[,1]
      dat <- dat %>%
