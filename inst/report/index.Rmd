...
```{r setup-load, include=FALSE, context="setup"}
...
```{r read-all-source, context="data", include = FALSE, messages = FALSE, echo = FALSE, eval = TRUE, cache=TRUE, cache.extra=file.info("bag.data")$mtime}
if (FALSE) {
...
```{r ageclasses-pandemic-month-calc, context="data", warning=FALSE, echo=FALSE, include=FALSE, cache=TRUE, cache.extra=file.info("datacases")$mtime}
...
```{r .extract_value-calc, warning=FALSE, echo=FALSE, include=FALSE}
...
```{r ageclasses-pandemic-month, warning=FALSE, out.width="100%", fig.asp=0.50, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-pandemic-month-100k, out.width="100%", fig.asp=0.50, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-vacc-perc, context="data",warning=FALSE, cache=TRUE, cache.extra=file.info("datavacc")$mtime}
Pop <- DATA.AG1M %>%
    filter((!AgeClass %in% c("unknown"))) %>%
    select(-Week) %>%  
    group_by(AgeClass) %>%
...
```
```{r ageclasses-vacc-perc-plot, warning=FALSE, out.width="100%", fig.asp=0.50, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-vacc-unvac-dataplot, context="data",warning=FALSE, cache=TRUE, cache.extra=file.info("dataplot")$mtime }
...
```
```{r ageclasses-vacc-unvac, out.width="100%", fig.asp=0.50, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-vacc-unvac-tab4-calc, echo=FALSE, include=FALSE, warning=FALSE,, context="data",warning=FALSE, cache=TRUE, cache.extra=file.info("datatabscale")$mtime }
...
```{r ageclasses-vacc-unvac-scale100k-plot, warning=FALSE, out.width="100%", fig.asp=0.50, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-vacc-unvac-scale100k-graph, warning=FALSE, out.width="100%", fig.asp=0.50, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-cases-scenarios-100k, out.width="100%", fig.asp=0.50, dpi=150, out.extra='class="img-centered img-responsive"'}
...
```{r ageclasses-cases-scenarios, out.width="100%", fig.asp=0.50, dpi=150, out.extra='class="img-centered img-responsive"', position = "absolute"}
...
```{r ageclasses-timeline-calc, context = "data", include = FALSE, echo = FALSE, cache=TRUE, cache.extra=file.info("DataRoll4W100k")$mtime}
...
```
```{r ageclasses-pandemic-hosp-deaths-timeline_100k-server, context="server", warning=FALSE, out.width="100%", fig.asp=0.85, dpi=150, out.extra='class="img-responsive"'}
#SERVER
data1 <- DataRoll4W100k %>% filter(AsOfDate %in% last_timeline_weeks)
...
```{r ageclasses-pandemic-hosp-deaths-timeline_ratio, context = "data", warning=FALSE, cache=TRUE, cache.extra=file.info("DataRoll4W100kratio")$mtime}
...
```
```{r ageclasses-pandemic-hosp-deaths-timeline_ratio-server, context = "server", warning=FALSE, out.width="100%", fig.asp=0.85, dpi=150, out.extra='class="img-responsive"'}
#SERVER
data2 <- DataRoll4W100kratio %>% filter(AsOfDate %in% last_timeline_weeks)
