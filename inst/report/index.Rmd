...
```{r library, context="setup", echo=FALSE, eval = TRUE}
...
```{r ageclasses-vacc-unvac-tab4-calc, echo=FALSE, include=FALSE, warning=FALSE}
...
```{r ageclasses-pandemic-hosp-deaths-timeline_ratio, context = "data", warning=FALSE}
