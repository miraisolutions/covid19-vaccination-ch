...
if (FALSE) {
  DATA = covid19vaccinationch:::read_bag_data_vac(bag_api_url, ageclassMap)
...
if (FALSE) {
  CASES = covid19vaccinationch:::read_bag_data_cases(bag_api_url, ageclassMap, dateweek = unique(DATA$Week))
